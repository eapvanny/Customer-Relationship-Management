...
class SportclubController extends Controller
{
    ...
    {
        $query = Sport_club::with('user', 'customer')->orderBy('id', 'desc');
        $user = auth()->user();
            ...
            return DataTables::of($reports)
               ...
               ->addColumn('outlet_id', function ($data) {
                ...
                ->addColumn('action', function ($data) {
                    $editRoute = route('school.edit', $data->id);
                    $deleteRoute = route('school.destroy', $data->id);
        ...
        return view('backend.sport-club.index', compact('is_filter', 'full_name'));
        // dd('HI Wholesale');
    ...
    public function create()
    {
        ...
        return view('backend.sport-club.add', compact('customer', 'customers','report','customerType'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('sport-club.index')->with('success', "Report has been created!");
    }
    ...
    {
        $report = Sport_club::with('user', 'customer')->find($id);
    ...
    public function edit($id)
    {
        ...
        if (!$report) {
            return redirect()->route('sport-club.index');
        }
        ...
        $customerType = AppHelper::CUSTOMER_TYPE;
        return view('backend.sport-club.add', compact('report', 'customers', 'customer','customerType'));
    }
    ...
    public function update(Request $request, $id)
    {
        $report = Sport_club::find($id);
        if (!$report) {
            return redirect()->route('sport-club.index')->with('error', 'Report not found!');
        }
        ...
        return redirect()->route('sport-club.index')->with('success', "Report has been updated!");
    }
    ...
    {
        // dd('HI Export');
        return Excel::download(new SportclubExport(), 'reports_sportclub_' . now()->format('Y_m_d_His') . '.xlsx');
    }
