...
class RetailController extends Controller
{
    ...
    public function store(Request $request)
    {
        $rules = [
            ...
            'retail_name' => 'required|string',
            'retail_contact' => 'required|string',
        ...
        $data['retail'] = [
            ...
            'depot_contact' => $request->depot_contact,
            'depot_name' => $request->depot_name,
            'retail_name' => $request->retail_name,
            'retail_contact' => $request->retail_contact,
    ...
    // dd('HI Show');
        ...
        return response()->json([
            'report' => [
                ...
                'modalRetailName' => $report->retail_name ?? 'N/A',
                'modalRetailContact' => $report->retail_contact ?? 'N/A',
                'modalOutletType' => $report->outlet_type ?? 'N/A',
                'modalSaleKPI' => $report->sale_kpi ?? 'N/A',
                'modalDisplayQty' => $report->display_qty ?? 'N/A',
                'modalSKU' => $report->sku ?? 'N/A',
                'modalIncentive' => $report->incentive ?? 'N/A',
                'modalRemark' => $report->remark ?? 'N/A',
                'modalLocation' => $report->province . ', ' . $report->district . ', ' . $report->commune ?? 'N/A',
