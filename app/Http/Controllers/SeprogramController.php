...
class seprogramController extends Controller
{
            ...
            return DataTables::of($reports)
               ...
               ->addColumn('outlet_id', function ($data) {
                ...
                ->addColumn('action', function ($data) {
                    $editRoute = route('se.edit', $data->id);
                    $deleteRoute = route('se.destroy', $data->id);
    ...
    public function create()
    {
        ...
        return view('backend.se.add', compact('customer', 'customers','report','customerType'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('se.index')->with('success', "Report has been created!");
    }
    ...
    {
        $report = Se_program::with('user', 'customer')->find($id);
    ...
    public function edit($id)
    {
        ...
        $customerType = AppHelper::CUSTOMER_TYPE;
        return view('backend.se.add', compact('report', 'customers', 'customer','customerType'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('se.index')->with('success', "Report has been updated!");
    }
