...
class RestaurantController extends Controller
{
    ...
    {
        $query = Restaurant::with('user', 'customer')->orderBy('id', 'desc');
        $user = auth()->user();
            ...
            return DataTables::of($reports)
               ...
               ->addColumn('outlet_id', function ($data) {
                ...
                ->addColumn('action', function ($data) {
                    $editRoute = route('restaurant.edit', $data->id);
                    $deleteRoute = route('restaurant.destroy', $data->id);
        ...
        return view('backend.restaurant.index', compact('is_filter', 'full_name'));
        // dd('HI Wholesale');
    ...
    public function create()
    {
        ...
        return view('backend.restaurant.add', compact('customer', 'customers','report','customerType'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('restaurant.index')->with('success', "Report has been created!");
    }
    ...
    {
        $report = Restaurant::with('user', 'customer')->find($id);
    ...
    public function edit($id)
    {
        ...
        $customerType = AppHelper::CUSTOMER_TYPE;
        return view('backend.restaurant.add', compact('report', 'customers', 'customer','customerType'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('restaurant.index')->with('success', "Report has been updated!");
    }
    ...
    {
        // dd('HI Export');
        return Excel::download(new RestaurantExport(), 'reports_restaurant_' . now()->format('Y_m_d_His') . '.xlsx');
    }
