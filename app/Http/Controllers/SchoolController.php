...
class SchoolController extends Controller
{
    ...
    {
        $query = School::with('user', 'customer')->orderBy('id', 'desc');
        $user = auth()->user();
        ...
        return view('backend.school.index', compact('is_filter', 'full_name'));
        // dd('HI Wholesale');
    ...
    public function create()
    {
        ...
        return view('backend.school.add', compact('customer', 'customers','report','customerType'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('school.index')->with('success', "Report has been created!");
    }
    ...
    {
        $report = School::with('user', 'customer')->find($id);
    ...
    public function edit($id)
    {
        ...
        $customerType = AppHelper::CUSTOMER_TYPE;
        return view('backend.school.add', compact('report', 'customers', 'customer','customerType'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('school.index')->with('success', "Report has been updated!");
    }
    ...
    {
        // dd('HI Export');
        return Excel::download(new SchoolExport(), 'reports_school_' . now()->format('Y_m_d_His') . '.xlsx');
    }
