...
class AsmprogramController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('backend.asm.add', compact('customer', 'customers','report','customerType'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('asm.index')->with('success', "Report has been created!");
    }
    ...
    {
        $report = Asm_program::with('user', 'customer')->find($id);
    ...
    public function edit($id)
    {
        ...
        $customerType = AppHelper::CUSTOMER_TYPE;
        return view('backend.asm.add', compact('report', 'customers', 'customer','customerType'));
    }
