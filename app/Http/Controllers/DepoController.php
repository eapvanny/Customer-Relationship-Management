            ...
            if ($request->ajax()) {
                ...
                return DataTables::of($depos)
                    ...
                    ->addColumn('action', function ($depo) {
                        ...
                        if (auth()->user()->role_id == AppHelper::USER_SUPER_ADMIN || auth()->user()->role_id == AppHelper::USER_ADMINISTRATOR || auth()->user()->role_id == AppHelper::USER_DIRECTOR || auth()->user()->role_id == AppHelper::USER_MANAGER) {
