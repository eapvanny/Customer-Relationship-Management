...
class ProvinceReportsExport  implements FromView
{
    protected $date1;
    protected $date2;
    protected $area_id;
    ...
    public function view(): View
    {
        ...
        $query = ProvinceReport::with(['user', 'customer','region','posm'])->orderBy('id', 'desc');
        ...
        return view('exports.province-reports', [
            'rows' => $query->get()
        ]);
    }
}