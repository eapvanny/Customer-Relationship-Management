...
class ExclusiveExport implements FromView
{
    protected $date1;
    protected $date2;
    protected $area_id;
    ...
    public function view(): View
    {
        ...
        $query = Exclusive::with('user', 'CustomerProvince', 'region', 'outlet', 'posm1', 'posm2', 'posm3')->orderBy('id', 'desc');
        ...
        return view('exports.exclusive-export', [
            'asm' => false,
            'rows' => $query->get(),
            'title' => __("Exclusive Customer Export"),
        ]);
    }
}
