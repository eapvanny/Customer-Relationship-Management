...
{
    /**
     * Run the migrations to create permission-related tables.
     */
    public function up(): void
    {
        ...
        Schema::create($tableNames['permissions'], function (Blueprint $table) {
            ...
            $table->integer('type')->default(1); // Support permission types (ALL, SALE, SE)
            $table->timestamps();
        ...
        Schema::create($tableNames['role_has_permissions'], function (Blueprint $table) use ($tableNames, $pivotRole, $pivotPermission) {
            ...
            $table->foreign($pivotPermission)->references('id')->on($tableNames['permissions'])->onDelete('cascade');
            $table->foreign($pivotRole)->references('id')->on($tableNames['roles'])->onDelete('cascade');
            $table->primary([$pivotPermission, $pivotRole, 'type'], 'role_has_permissions_permission_id_role_id_type_primary');
        });
    ...
    /**
     * Reverse the migrations by dropping all permission-related tables.
     */
