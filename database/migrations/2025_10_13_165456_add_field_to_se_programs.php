...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('se_programs', function (Blueprint $table) {
            ...
            $table->string('posm_1')->nullable()->after('foc_1500_qty');
    ...
    {
        Schema::table('se_programs', function (Blueprint $table) {
            $table->dropColumn(['foc_250_qty', 'foc_350_qty', 'foc_600_qty', 'foc_1500_qty', 'posm_1', 'posm_1_qty', 'posm_2', 'posm_2_qty', 'posm_3', 'posm_3_qty']);
