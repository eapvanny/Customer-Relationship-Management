...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('wholesales', function (Blueprint $table) {
            ...
            $table->string('wholesale_contact')->nullable();
            ...
            // Optionally add foreign keys if user_id/apply_user refer to users table
            // $table->foreign('user_id')->references('id')->on('users')->onDelete('set null');
            // $table->foreign('apply_user')->references('id')->on('users')->onDelete('set null');
        });
    }
