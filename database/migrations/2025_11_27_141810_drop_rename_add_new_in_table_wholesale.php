...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('wholesales', function (Blueprint $table) {
            ...
            if (Schema::hasColumn('wholesales', 'location')) {
                $table->dropColumn('location');
            }

            if (Schema::hasColumn('wholesales', 'foc_qty')) {
                $table->dropColumn('foc_qty');
            }


            // Rename 'business_type' to 'outlet_type'
            if (Schema::hasColumn('wholesales', 'business_type')) {
    ...
    public function down(): void
    {
        Schema::table('wholesales', function (Blueprint $table) {
            ...
            if (Schema::hasColumn('wholesales', 'outlet_type')) {
