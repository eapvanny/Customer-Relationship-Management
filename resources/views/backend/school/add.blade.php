...
@section('pageContent')
    ...
    <section class="content">
        <form novalidate id="entryForm"
            action="@if ($report) {{ URL::Route('school.update', $report->id) }} @else {{ URL::Route('school.store') }} @endif"
                ...
                <div class="col-md-12">
                    <div class="wrap-outter-header-title">
                        ...
                        <div class="action-btn-top none_fly_action_btn">
                            <a href="{{ URL::route('school.index') }}" class="btn btn-default">{{ __('Cancel') }}</a>
