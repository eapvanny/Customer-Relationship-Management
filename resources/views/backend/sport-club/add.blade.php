...
@section('pageContent')
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href="{{ URL::route('sport-club.index') }}"> {{ __('Sport club') }} </a></li>
            <li class="active">
                @if ($report)
                    {{ __('Update') }}
                @else
    ...
    <section class="content">
        <form novalidate id="entryForm"
            action="@if ($report) {{ URL::Route('sport-club.update', $report->id) }} @else {{ URL::Route('sport-club.store') }} @endif"
                ...
                <div class="col-md-12">
                    <div class="wrap-outter-header-title">
                        ...
                        <div class="box-tools pull-right">
                            <a href="{{ URL::route('sport-club.index') }}" class="btn btn-default">{{ __('Cancel') }}</a>
