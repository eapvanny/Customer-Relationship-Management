...
@section('pageContent')
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href=""> {{ __('Exclusive Customer') }} </a></li>
            <li><a href="{{ URL::route('sportClub.index') }}"> {{ __('Sport club') }} </a></li>
            <li class="active">
                @if ($report)
                    {{ __('Update') }}
                @else
    ...
    <section class="content">
        <form novalidate id="entryForm"
            action="@if ($report) {{ URL::Route('sportClub.update', $report->id) }} @else {{ URL::Route('sportClub.store') }} @endif"
                ...
                <div class="col-md-12">
                    <div class="wrap-outter-header-title">
                        ...
                        <div class="action-btn-top none_fly_action_btn">
                            <a href="{{ URL::route('sportClub.index') }}" class="btn btn-default">{{ __('Cancel') }}</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-xl-6">
                            <div class="form-group has-feedback">
                                ...
                                <select name="customer_type" readonly id="customer_type" class="form-control select2" required>
                                    <option value="" selected disabled>{{ __('Select customer type') }}</option>
                                    @foreach ($customerType as $key => $value)
                                        <option value="{{ $key }}"
                                            @if ( strtolower($value) == 'តារាងបាល់')
                                                selected
                                            @endif>
                                            {{ $value }}
                                        </option>
