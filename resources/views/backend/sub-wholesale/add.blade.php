                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        @if ($takePicture == null)
                            <div class="col-md-6 col-xl-6">
                                <div class="form-group has-feedback">
                                    ...
                                    <input type="text" class="form-control" name="region" id="region"
                                        value="{{ isset($report) ? $report['region'] : old('region') }}"
                            ...
                            <div class="col-lg-6 col-md-6 col-xl-6">
                                <div class="form-group has-feedback">
                                    ...
                                    <input type="text" class="form-control" name="sm_name" id="sm_name"
                                        value="{{ isset($report) ? $report['sm_name'] : old('sm_name') }}"
                                        placeholder="{{ __("SM's Name") }}" required>
                                    <span class="fa fa-info form-control-feedback"></span>
                            ...
                            <div class="col-lg-6 col-md-6 col-xl-6">
                                <div class="form-group has-feedback">
                                    ...
                                    <input type="text" class="form-control" name="rsm_name" id="rsm_name"
                                        value="{{ isset($report) ? $report['rsm_name'] : old('rsm_name') }}"
                                        placeholder="{{ __("RSM's Name") }}" required>
                                    <span class="fa fa-info form-control-feedback"></span>
                            ...
                            <div class="col-lg-6 col-md-6 col-xl-6">
                                <div class="form-group has-feedback">
                                    <label for="asm_name">{{ __("ASM's Name") }} <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="asm_name" id="asm_name"
                                        value="{{ isset($report) ? $report['asm_name'] : old('asm_name') }}"
                                        placeholder="{{ __("ASM's Name") }}" required>
                                    <span class="fa fa-info form-control-feedback"></span>
                            ...
                            <div class="col-lg-6 col-md-6 col-xl-6">
                                <div class="form-group has-feedback">
                                    <label for="se_name">{{ __("SE's Name") }} <span
                                            class="text-danger">*</span></label>
                            ...
                            <div class="col-lg-6 col-md-6 col-xl-6">
                                <div class="form-group has-feedback">
                                    <label for="se_code">{{ __("SE's Code") }} <span
                                            class="text-danger">*</span></label>
                            ...
                            <div class="col-lg-6 col-md-6 col-xl-6">
                                <div class="form-group has-feedback">
                                    <label for="customer_code">{{ __("Customer's Code") }} <span
                                            class="text-danger">*</span></label>
                            ...
                            <div class="col-lg-6 col-md-6 col-xl-6">
                                <div class="form-group has-feedback">
                                    <label for="depot_contact">{{ __('Depot Contact') }} <span
                                            class="text-danger">*</span></label>
                            ...
                            <div class="col-lg-6 col-md-6 col-xl-6">
                                <div class="form-group has-feedback">
                                    <label for="sub_ws_name">{{ __("Sub-wholesale's Name") }} <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="sub_ws_name" id="sub_ws_name"
                                        value="{{ isset($report) ? $report['sub_ws_name'] : old('sub_ws_name') }}"
                                        placeholder="{{ __("Sub-wholesale's Name") }}" required>

                                    <span class="fa fa-info form-control-feedback"></span>
                                    <span class="text-danger">{{ $errors->first('sub_ws_name') }}</span>
                                </div>
                            </div>

                            <div class="col-lg-6 col-md-6 col-xl-6">
                                <div class="form-group has-feedback">
                                    <label for="sub_ws_contact">{{ __("Sub-wholesale's Contact") }} <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="sub_ws_contact" id="sub_ws_contact"
                                        value="{{ isset($report) ? $report['sub_ws_contact'] : old('sub_ws_contact') }}"
                                        placeholder="{{ __("Sub-wholesale's Contact") }}" required>

                                    <span class="fa fa-info form-control-feedback"></span>
                                    <span class="text-danger">{{ $errors->first('sub_ws_contact') }}</span>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-xl-6">
                                <div class="form-group has-feedback">
                                    <label for="outlet_type">{{ __('Outlet Type') }} <span
                                            class="text-danger">*</span></label>
                            ...
                            <div class="col-lg-6 col-md-6 col-xl-6">
                                <div class="form-group has-feedback">
                                    ...
                                    <input type="number" class="form-control" name="sale_kpi" id="sale_kpi"
                                        min="0"
                            ...
                            <div class="col-lg-6 col-md-6 col-xl-6">
                                <div class="form-group has-feedback">
                                    <label for="display_qty">{{ __('Display QTY') }} <span
                                            class="text-danger">*</span></label>
                                    <input type="number" min="0" class="form-control" name="display_qty"
                                        id="display_qty"
