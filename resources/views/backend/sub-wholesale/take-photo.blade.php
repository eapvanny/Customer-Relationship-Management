...
@section('pageContent')
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href="{{ URL::route('sub-wholesale-import.index') }}"> {{ __('Sub wholesale') }} </a></li>
            <li class="active">
                @if ($report)
                    {{ __('Update') }}
                @else
    ...
    <section class="content">
        <form novalidate id="entryForm"
            action="@if ($report) {{ URL::Route('sub-wholesale-import.update', $report->id) }} @else {{ URL::Route('sub-wholesale-import.store') }} @endif"
                ...
                <div class="col-md-12">
                    <div class="wrap-outter-header-title">
                        ...
                        <div class="box-tools pull-right">
                            <a href="{{ URL::route('sub-wholesale-import.index') }}" class="btn btn-default">{{ __('Cancel') }}</a>
