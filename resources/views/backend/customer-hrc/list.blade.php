...
<section class="content-header">
    <ol class="breadcrumb">
        ...
        <li class="active">{{ __('Customer_HRC') }}</li>
    </ol>
</section>
            ...
            <div class="wrap-outter-header-title">
                ...
                <div class="action-btn-top none_fly_action_btn">
                    ...
                    {{-- @hasTypePermission('create customer') --}}
                        <a href="{{ route('customerhrc.create') }}" class="btn btn-primary">
                    ...
                    <div class="box-header">
                        <div class="row">
                            <div class="col-12 mb-2">
                                <form action="{{ route('customerhrc.index') }}" method="GET" id="filterForm">
                                    <div class="wrap_filter_form @if (!$is_filter) collapse @endif"
                                        ...
                                        <div class="row">
                                            <div class="col-12 mt-2">
                                                ...
                                                <a href="{{ route('customerhrc.index') }}"
...
<script>
    $(document).ready(function() {
        const table = $('#datatable').DataTable({
            ...
            ajax: {
                url: "{!! route('customerhrc.index', Request::query()) !!}",
                type: "GET",
                headers: {
