...
@section('pageContent')
    ...
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href="{{ URL::route('customerhrc.index') }}"> {{ __('Customer HRC') }} </a></li>
            <li class="active">
                @if ($customerHRC)
                    {{ __('Update') }}
                @else
    ...
    <section class="content">
        <form id="entryForm"
            action="@if ($customerHRC) {{ URL::Route('customerhrc.update', $customerHRC->id) }} @else {{ URL::Route('customerhrc.store') }} @endif"
            method="post" autocomplete="off">
            <div class="row">
                <div class="col-md-12">
                    <div class="wrap-outter-header-title">
                        <h4>{{ __('Customer HRC') }}</h4>
                        <div class="action-btn-top none_fly_action_btn">
                            <a href="{{ URL::route('customerhrc.index') }}" class="btn btn-default"> {{ __('Cancel') }} </a>
                            <button type="submit" class="submitClick btn btn-info pull-right text-white">
                                <i class="fa @if ($customerHRC) fa-refresh @else fa-check-circle @endif"></i>
                                @if ($customerHRC)
                                    {{ __('Update') }}
                                @else
                                    {{ __('Save') }}
                    ...
                    <div class="box-body">
                        <div class="row">   
                            <div class="col-md-6 col-xl-6">
                                <div class="form-group has-feedback">
                                    ...
                                    <input type="text" name="area" class="form-control"
                                        value="{{ old('area', $customerHRC->area ?? '') }}" required>
                            ...
                            <div class="col-lg-6 col-md-6 col-xl-6">
                                <div class="form-group has-feedback">
                                    ...
                                    <input type="text" name="name" class="form-control"
                                        value="{{ old('name', $customerHRC->name ?? '') }}" required>
                            ...
                            <div class="col-lg-6 col-md-6 col-xl-6">
                                <div class="form-group has-feedback">
                                    ...
                                    <input type="tel" class="form-control" name="phone"
                                        ...
                                        value="@if ($customerHRC) {{ $customerHRC->phone }}@else{{ old('phone') }} @endif">
                                         <span class="fa fa-user form-control-feedback"></span>
                            ...
                            <div class="form-group has-feedback">
                                ...
                                {!! Form::select('customer_type', $customerHRCType, old('customer_type', optional($customerHRC)->customer_type), [
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group has-feedback position-relative">
                                                        ...
                                                        <fieldset id="outlet-photo-upload"
                                                            ...
                                                            <img class="rounded mx-auto d-block @if (!old('old_outlet_photo') && !isset($customerHRC->outlet_photo)) d-none @endif z-1"
                                                                id="outlet-photo-preview" name="old_outlet_photo"
                                                                src="@if (isset($customerHRC->outlet_photo)) {{ asset('storage/' . $customerHRC->outlet_photo) }} @else {{ old('old_outlet_photo') }} @endif"
                                                                alt="outlet-photo">
                                                            <input type="hidden" id="outlet-img-preview"
                                                                name="old_outlet_photo"
                                                                value="@if (isset($customerHRC->outlet_photo)) {{ $customerHRC->outlet_photo }} @endif">
                                                            <div class="d-flex align-items-center justify-content-center bg-transparent z-2 @if (!old('outlet-img-preview') && !isset($customerHRC->outlet_photo)) opacity-100 @else opacity-25 @endif"
                                                            ...
                                                            <label id="outlet-camera-label"
                                                                ...
                                                                @if (isset($customerHRC->outlet_photo) || old('outlet-img-preview'))
                                    ...
                                    <div class="col-lg-6 col-md-6 col-xl-6">
                                        <div class="form-group has-feedback">
                                            ...
                                            <input type="text" class="form-control" name="latitude" id="latitude"
                                                value="{{ isset($customerHRC) ? $customerHRC->latitude : old('latitude') }}"
                                                readonly required>
                                                <span class="fa fa-info form-control-feedback"></span>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-xl-6">
                                        <div class="form-group has-feedback">
                                            ...
                                            <input type="text" class="form-control" name="longitude" id="longitude"
                                                value="{{ isset($customerHRC) ? $customerHRC->longitude : old('longitude') }}"
                                                readonly required>
                                                <span class="fa fa-info form-control-feedback"></span>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-xl-6">
                                        <div class="form-group has-feedback">
                                            <label for="city">{{ __('Address') }}<span
                                                    class="text-danger">*</span></label>
                                            <textarea class="form-control" name="city" id="city" cols="30" rows="1" readonly required>{{ isset($customerHRC) ? $customerHRC->city : old('city') }}</textarea>
                                            <span class="fa fa-info form-control-feedback"></span>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-xl-6">
                                        <div class="form-group has-feedback">
                                            ...
                                            <input type="text" class="form-control" name="country" id="country"
                                                value="{{ isset($customerHRC) ? $customerHRC->country : old('country') }}" readonly
                                                required>
                                                <span class="fa fa-info form-control-feedback"></span>
...
@section('extraScript')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            @if ($customerHRC && $customerHRC->latitude && $customerHRC->longitude)
                window.onload = function() {
                    initMap({{ $customerHRC->latitude }}, {{ $customerHRC->longitude }});
                }
            @else
                window.onload = function() {
                    initMap(0, 0);
           ...
           // Handle form submission for Save and Save & Add New
            ...
            @if ($customerHRC && $customerHRC->outlet_photo)
