...
@section('pageContent')
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href="{{ URL::route('wholesale.index') }}"> {{ __('Wholesale') }} </a></li>
            <li class="active">
                @if ($report)
                    {{ __('Update') }}
                @else
    ...
    <section class="content">
        <form novalidate id="entryForm"
            action="@if ($report) {{ URL::Route('wholesale.update', $report->id) }} @else {{ URL::Route('wholesale.store') }} @endif"
                ...
                <div class="col-md-12">
                    <div class="wrap-outter-header-title">
                        ...
                        <div class="action-btn-top none_fly_action_btn">
                            <a href="{{ URL::route('wholesale.index') }}" class="btn btn-default">{{ __('Cancel') }}</a>
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        @if($takePicture == null)
                            ...
                            <div class="col-lg-6 col-md-6 col-xl-6">
                                <div class="form-group has-feedback">
                                    <label for="wholesale_name">{{ __("Wholesale's Name") }} <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="wholesale_name" id="wholesale_name"
                                        value="{{ isset($report) ? $report['wholesale_name'] : old('wholesale_name') }}"
                                        placeholder="{{ __("Wholesale's Name") }}" required>

                                    <span class="fa fa-info form-control-feedback"></span>
                                    <span class="text-danger">{{ $errors->first('wholesale_name') }}</span>
                                </div>
                            </div>

                            <div class="col-lg-6 col-md-6 col-xl-6">
                                <div class="form-group has-feedback">
                                    <label for="wholesale_contact">{{ __("Wholesale's Contact") }} <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="wholesale_contact" id="wholesale_contact"
                                        value="{{ isset($report) ? $report['wholesale_contact'] : old('wholesale_contact') }}"
                                        placeholder="{{ __("Wholesale's Contact") }}" required>

                                    <span class="fa fa-info form-control-feedback"></span>
                                    <span class="text-danger">{{ $errors->first('wholesale_contact') }}</span>
                                </div>
                            </div>
